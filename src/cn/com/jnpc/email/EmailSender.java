...
public class EmailSender {
	...
	public void send(String emailTo, Meeting meeting, String type) {
		...
		try {
			...
			if ("4".equals(type)) {
				...
				sb.append("</th></tr>");
				sb.append("<tr align='center'><td align='right'>培训地点：</td><td align='left'>");
				sb.append(meeting.getRoomid());
				sb.append("</td></tr>");
				sb.append("<tr align='center'><td align='right'>培训时间：</td><td align='left'>");
				sb.append(meeting.getStarttime() + "至" + meeting.getEndtime());
				sb.append("</td></tr>");
				sb.append("<tr align='center'><td align='right'>培训内容：</td><td align='left'>");
				sb.append(meeting.getContent());
				sb.append("</td></tr>");
				sb.append("</td></tr>");
				// sb.append
	...
	public void send(Meeting meeting, String warning) {
		HtmlEmail email = new HtmlEmail();
		email.setHostName(EmailConfigReader.getHost());
		email.setDebug(EmailConfigReader.getDebug());
		email.setAuthentication(EmailConfigReader.getUsername(),
