...
public class MeetingServlet extends BaseServlet {
	...
	public String list() {
		if (vec.contains("380101")) {
			...
			String starttime = request.getParameter("_starttime") != null ? request
					.getParameter("_starttime") : request
			...
			String endtime2 = request.getParameter("_endtime2") != null ? request
					.getParameter("_endtime2") : request
					.getParameter("endtime2");
			String org = request.getParameter("_org") != null ? request
					.getParameter("_org") : request.getParameter("org");
			String buildingid = request.getParameter("_buildingid") != null ? request
					.getParameter("_buildingid") : request
			...
			String roomName = request.getParameter("_roomName") != null ? request
					.getParameter("_roomName") : request
	...
	public String toUpdate() {
		...
		String id = request.getParameter("id");
		String xv = request.getParameter("xv") != null ? request
				.getParameter("xv") : "";
